const database = {
  ...
  programmer: {
    ...
    paragraph: `Jako programista odpowiadam za odwzorowanie całego projektu strony za pomocą kodu, tak aby strona odpowiednio wyświetlała się w przeglądarce internetowej. Implementacja strony nie dotyczy jedynie wyglądu, ale na przykład tego, aby osoby nie widzące mogły z niej wydajnie korzystać. Swoją wiedzę i umiejętności czerpie ze studiów informatycznych oraz szkoleń.`,
  },
  designer: {
